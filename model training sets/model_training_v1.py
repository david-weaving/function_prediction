...
# Define the model
model = Sequential()
model.add(LSTM(50, input_shape=(4, 1)))  # Adjust input shape according to your sequence length
model.add(Dense(64, activation='relu'))  # Adds a dense layer with 64 neurons and ReLU activation
...
model.save("models/my_model_v8.h5")
