...
x_train_split, x_val_split, y_train_split, y_val_split = train_test_split(
    x_train_reshaped, y_train_encoded, test_size=0.2, random_state=13) # 10 is good
...
history = model.fit(x_train_reshaped, y_train_encoded, 
                    ...
                    epochs=90, batch_size=batch_size, steps_per_epoch=steps_per_epoch)
...
# Save the model
model.save("C:/Users/Administrator/func pred/function_prediction/models/model_V1_2.h5")
